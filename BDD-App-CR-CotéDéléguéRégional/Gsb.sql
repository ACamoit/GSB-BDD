...
CREATE TABLE `EVALUATION` (
  `EVA_NUM` int(11) NOT NULL,
  `EVA_LIBELLE` varchar(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`EVA_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `EVALUATION` VALUES (0,'Tr?s Mauvais'),(1,'Mauvais'),(2,'Moyen'),(3,'Bon'),(4,'Tr?s Bon');
...
CREATE TABLE `MOTIF` (
  ...
  `MOT_LIBELLE` varchar(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`MOT_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `MOTIF` VALUES (0,'mise a jour date de '),(1,'nouveaut'),(2,'actualisations'),(3,'autres');
...
CREATE TABLE `PRATICIEN` (
  ...
  `PRA_COEFCONFIANCE` float DEFAULT '3',
...
INSERT INTO `PRATICIEN` VALUES (1,'Notini','Alain','114 r Authie','85000','LA ROCHE SUR YON',290.03,3,'MH'),(2,'Gosselin','Albert','13 r Devon','41000','BLOIS',307.49,4,'MV'),(3,'Delahaye','Andr','36 av 6 Juin','25000','BESANCON',185.79,1,'PS'),(4,'Leroux','Andr','47 av Robert Schuman','60000','BEAUVAIS',172.04,0,'PH'),(5,'Desmoulins','Anne','31 r St Jean','30000','NIMES',94.75,4,'PO'),(6,'Mouel','Anne','27 r Auvergne','80000','AMIENS',45.2,2,'MH'),(7,'Desgranges-Lentz','Antoine','1 r Albert de Mun','29000','MORLAIX',20.07,0,'MV'),(8,'Marcouiller','Arnaud','31 r St Jean','68000','MULHOUSE',396.52,1,'PS'),(9,'Dupuy','Benoit','9 r Demolombe','34000','MONTPELLIER',395.66,2,'PH'),(10,'Lerat','Bernard','31 r St Jean','59000','LILLE',257.79,3,'PO'),(11,'Mar?ais-Lefebvre','Bertrand','86Bis r Basse','67000','STRASBOURG',450.96,4,'MH'),(12,'Boscher','Bruno','94 r Falaise','10000','TROYES',356.14,3,'MV'),(13,'Morel','Catherine','21 r Chateaubriand','75000','PARIS',379.57,2,'PS'),(14,'Guivarch','Chantal','4 av G?n Laperrine','45000','ORLEANS',114.56,1,'PH'),(15,'Bessin-Grosdoit','Christophe','92 r Falaise','6000','NICE',222.06,0,'PO'),(16,'Rossa','Claire','14 av Thi','6000','NICE',529.78,2,'MH'),(17,'Cauchy','Denis','5 av Ste Th?r?se','11000','NARBONNE',458.82,4,'MV'),(18,'Gaff','Dominique','9 av 1?re Arm?e Fran?aise','35000','RENNES',213.4,1,'PS'),(19,'Guenon','Dominique','98 bd Mar Lyautey','44000','NANTES',175.89,3,'PH'),(20,'Pr?vot','Dominique','29 r Lucien Nelle','87000','LIMOGES',151.36,2,'PO'),(21,'Houchard','Eliane','9 r Demolombe','49100','ANGERS',436.96,3,'MH'),(22,'Desmons','Elisabeth','51 r Berni?res','29000','QUIMPER',281.17,1,'MV'),(23,'Flament','Elisabeth','11 r Pasteur','35000','RENNES',315.6,4,'PS'),(24,'Goussard','Emmanuel','9 r Demolombe','41000','BLOIS',40.72,4,'PH'),(25,'Desprez','Eric','9 r Vaucelles','33000','BORDEAUX',406.85,1,'PO'),(26,'Coste','Evelyne','29 r Lucien Nelle','19000','TULLE',441.87,1,'MH'),(27,'Lefebvre','Fr?d?ric','2 pl Wurzburg','55000','VERDUN',573.63,2,'MV'),(28,'Lem','Fr?d?ric','29 av 6 Juin','56000','VANNES',326.4,3,'PS'),(29,'Martin','Fr?d?ric','B?t A 90 r Bayeux','70000','VESOUL',506.06,4,'PH'),(30,'Marie','Fr?d?rique','172 r Caponi?re','70000','VESOUL',313.31,0,'PO'),(31,'Rosenstech','Genevi?ve','27 r Auvergne','75000','PARIS',366.82,1,'MH'),(32,'Pontavice','Ghislaine','8 r Gaillon','86000','POITIERS',265.58,3,'MV'),(33,'Leveneur-Mosquet','Guillaume','47 av Robert Schuman','64000','PAU',184.97,2,'PS'),(34,'Blanchais','Guy','30 r Authie','8000','SEDAN',502.48,3,'PH'),(35,'Leveneur','Hugues','7 pl St Gilles','62000','ARRAS',7.39,1,'PO'),(36,'Mosquet','Isabelle','22 r Jules Verne','76000','ROUEN',77.1,3,'MH'),(37,'Giraudon','Jean-Christophe','1 r Albert de Mun','38100','VIENNE',92.62,4,'MV'),(38,'Marie','Jean-Claude','26 r H?rouville','69000','LYON',120.1,0,'PS'),(39,'Maury','Jean-Fran?ois','5 r Pierre Girard','71000','CHALON SUR SAONE',13.73,0,'PH'),(40,'Dennel','Jean-Louis','7 pl St Gilles','28000','CHARTRES',550.69,1,'PO'),(41,'Ain','Jean-Pierre','4 r?sid Olympia','2000','LAON',5.59,3,'MH'),(42,'Chemery','Jean-Pierre','51 pl Ancienne Boucherie','14000','CAEN',396.58,4,'MV'),(43,'Comoz','Jean-Pierre','35 r Auguste Lechesne','18000','BOURGES',340.35,2,'PS'),(44,'Desfaudais','Jean-Pierre','7 pl St Gilles','29000','BREST',71.76,3,'PH'),(45,'Phan','J?r?me','9 r Clos Caillet','79000','NIORT',451.61,4,'PO'),(46,'Riou','Line','43 bd G?n Vanier','77000','MARNE LA VALLEE',193.25,3,'MH'),(47,'Chubilleau','Louis','46 r Eglise','17000','SAINTES',202.07,2,'MV'),(48,'Lebrun','Lucette','178 r Auge','54000','NANCY',410.41,0,'PS'),(49,'Goessens','Marc','6 av 6 Juin','39000','DOLE',548.57,1,'PH'),(50,'Laforge','Marc','5 r?sid Prairie','50000','SAINT LO',265.05,1,'PO'),(51,'Millereau','Marc','36 av 6 Juin','72000','LA FERTE BERNARD',430.42,3,'MH'),(52,'Dauverne','Marie-Christine','69 av Charlemagne','21000','DIJON',281.05,2,'MV'),(53,'Vittorio','Myriam','3 pl Champlain','94000','BOISSY SAINT LEGER',356.23,3,'PS'),(54,'Lapasset','Nhieu','31 av 6 Juin','52000','CHAUMONT',107,4,'PH'),(55,'Plantet-Besnier','Nicole','10 av 1?re Arm?e Fran?aise','86000','CHATELLEREAULT',369.94,3,'PO'),(56,'Chubilleau','Pascal','3 r Hastings','15000','AURRILLAC',290.75,0,'MH'),(57,'Robert','Pascal','31 r St Jean','93000','BOBIGNY',162.41,3,'MV'),(58,'Jean','Pascale','114 r Authie','49100','SAUMUR',375.52,0,'PS'),(59,'Chanteloube','Patrice','14 av Thi','13000','MARSEILLE',478.01,3,'PH'),(60,'Lecuirot','Patrice','r?sid St P?res 55 r Pigaci?re','54000','NANCY',239.66,1,'PO'),(61,'Gandon','Patrick','47 av Robert Schuman','37000','TOURS',599.06,3,'MH'),(62,'Mirouf','Patrick','22 r Puits Picard','74000','ANNECY',458.42,2,'MV'),(63,'Boireaux','Philippe','14 av Thi','10000','CHALON EN CHAMPAGNE',454.48,1,'PS'),(64,'Cendrier','Philippe','7 pl St Gilles','12000','RODEZ',164.16,4,'PH'),(65,'Duhamel','Philippe','114 r Authie','34000','MONTPELLIER',98.62,3,'PO'),(66,'Grigy','Philippe','15 r M?lingue','44000','CLISSON',285.1,0,'MH'),(67,'Linard','Philippe','1 r Albert de Mun','81000','ALBI',486.3,3,'MV'),(68,'Lozier','Philippe','8 r Gaillon','31000','TOULOUSE',48.4,0,'PS'),(69,'Dech?tre','Pierre','63 av Thi','23000','MONTLUCON',253.75,2,'PH'),(70,'Goessens','Pierre','22 r Jean Romain','40000','MONT DE MARSAN',426.19,4,'PO'),(71,'Lem?nager','Pierre','39 av 6 Juin','57000','METZ',118.7,3,'MH'),(72,'N','Pierre','39 av 6 Juin','82000','MONTAUBAN',72.54,2,'MV'),(73,'Guyot','Pierre-Laurent','43 bd G?n Vanier','48000','MENDE',352.31,3,'PS'),(74,'Chauchard','Roger','9 r Vaucelles','13000','MARSEILLE',552.19,4,'PH'),(75,'Mabire','Roland','11 r Boutiques','67000','STRASBOURG',422.39,1,'PO'),(76,'Leroy','Soazig','45 r Boutiques','61000','ALENCON',570.67,2,'MH'),(77,'Guyot','St?phane','26 r H?rouville','46000','FIGEAC',28.85,1,'MV'),(78,'Delposen','Sylvain','39 av 6 Juin','27000','DREUX',292.01,0,'PS'),(79,'Rault','Sylvie','15 bd Richemond','2000','SOISSON',526.6,3,'PH'),(80,'Renouf','Sylvie','98 bd Mar Lyautey','88000','EPINAL',425.24,3,'PO'),(81,'Alliet-Grach','Thierry','14 av Thi','7000','PRIVAS',451.31,0,'MH'),(82,'Bayard','Thierry','92 r Falaise','42000','SAINT ETIENNE',271.71,4,'MV'),(83,'Gauchet','Thierry','7 r Desmoueux','38100','GRENOBLE',406.1,3,'PS'),(84,'Bobichon','Tristan','219 r Caponi?re','9000','FOIX',218.36,0,'PH'),(85,'Duchemin-Laniel','V?ronique','130 r St Jean','33000','LIBOURNE',3,265.61,'PO'),(86,'Laurent','Youn','34 r Demolombe','53000','MAYENNE',496.1,4,'MH');
...
CREATE TABLE `RAPPORT_VISITE` (
  ...
  `RAP_CONSUL` tinyint(1) NOT NULL DEFAULT '0',
  `RAP_DATE` date NOT NULL,
  `MOT_NUM` int(11) NOT NULL,
  `EVA_NUM` int(11) NOT NULL,
  `ESTVU` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`RAP_NUM`),
  KEY `FK_RAPPORT_VISITE_VISITEUR` (`VIS_MATRICULE`),
  KEY `FK_RAPPORT_VISITE_PRATICIEN` (`PRA_NUM`),
  KEY `FK_RAPPORT_VISITE_MOTIF` (`MOT_NUM`),
  KEY `FK_RAPPORT_VISITE_EVALUATION` (`EVA_NUM`),
  CONSTRAINT `FK_RAPPORT_VISITE_EVALUATION` FOREIGN KEY (`EVA_NUM`) REFERENCES `EVALUATION` (`EVA_NUM`),
  CONSTRAINT `FK_RAPPORT_VISITE_MOTIF` FOREIGN KEY (`MOT_NUM`) REFERENCES `MOTIF` (`MOT_NUM`),
...
INSERT INTO `RAPPORT_VISITE` VALUES ('a131',1,1,'Bonne visite, tout les echantillons ont ?t? donn?s. Le practicien ?tait plus int?r?cer par le TRIMYCINE',0,'2017-11-10',1,1,1),('c14',2,7,'Pas tr?s bonne visite, aucun echantillon retenue. Ne veut pas sengager pour tester les ?chantillons ',0,'2017-11-10',1,2,0),('e5',3,45,'Rien de pr?cie a rapporter ',0,'2017-11-10',0,1,0),('h35',4,22,'A besion de plus de pr?cision sur les ?chantillons',0,'2017-11-10',3,4,0),('t43',5,16,'Potentiel achat du A86',0,'2017-11-10',2,3,0),('j50',6,78,'Abssent ',0,'2017-11-10',2,2,0),('l23',7,3,'Prescrition requise ',0,'2017-11-10',3,3,1),('e5',8,22,'Adresse pas mise a jour.',0,'2017-11-10',0,3,0),('l23',9,16,'',0,'2017-11-10',1,0,1);
...
CREATE TABLE `VISITEUR` (
  ...
  `VIS_MDP` varchar(25) DEFAULT NULL,
...
INSERT INTO `VISITEUR` VALUES ('a131','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08','azerty',NULL,'SW'),('a17','Andre','David','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19','azerty',NULL,'GY'),('a55','Bedos','Christian','1 rue B?n?dictins','65000','TARBES','2007-09-07','azerty',NULL,'GY'),('a93','Tusseau','Louis','22 rue Renou','86000','POITIERS','2001-02-09','azerty',NULL,'SW'),('b13','Bentot','Pascal','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06','azerty',NULL,'GY'),('b16','Bioret','Luc','1 rue Linne','35000','RENNES','2003-01-06','azerty',NULL,'SW'),('b19','Bunisset','Francis','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23','azerty',NULL,'GY'),('b25','Bunisset','Denise','1 rue Lionne','49100','ANGERS','2007-03-04','azerty',NULL,'SW'),('b28','Cacheux','Bernard','114 rue Authie','34000','MONTPELLIER','2008-02-10','azerty',NULL,'GY'),('b34','Cadic','Eric','123 rue Caponi?re','41000','BLOIS','2012-06-03','azerty','P','SW'),('b4','Charoze','Catherine','100 place G?ants','33000','BORDEAUX','2009-05-07','azerty',NULL,'SW'),('b50','Clepkens','Christophe','12 rue F?d?rico Garcia Lorca','13000','MARSEILLE','2011-08-18','azerty',NULL,'SW'),('b59','Cottin','Vincenne','36 square Capucins','5000','GAP','2010-12-19','azerty',NULL,'GY'),('c14','Daburon','Fran?ois','13 rue Champs Elys?es','6000','NICE','2012-01-20','azerty','S','SW'),('c3','De','Philippe','13 rue Charles Peguy','10000','TROYES','2005-05-29','azerty',NULL,'SW'),('c54','Debelle','Michel','181 rue Caponi?re','88000','EPINAL','2004-09-19','azerty',NULL,'SW'),('d13','Debelle','Jeanne','134 rue Stalingrad','44000','NANTES','2012-05-25','azerty',NULL,'SW'),('d51','Debroise','Michel','2 avenue 6 Juin','70000','VESOUL','2011-08-17','azerty','E','GY'),('e22','Desmarquest','Nathalie','14 rue F?d?rico Garcia Lorca','54000','NANCY','2013-04-18','azerty',NULL,'GY'),('e24','Desnost','Pierre','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','azerty','E','SW'),('e39','Dudouit','Fr?d?ric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18','azerty',NULL,'GY'),('e49','Duncombe','Claude','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16','azerty',NULL,'GY'),('e5','Enault-Pascreau','C?line','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','azerty','S','GY'),('e52','Eynde','Val?rie','3 rue Henri Moissan','76000','ROUEN','2012-09-16','azerty',NULL,'GY'),('f21','Finck','Jacques','route Montreuil Bellay','74000','ANNECY','2012-09-16','azerty',NULL,'SW'),('f39','Fr?mont','Fernande','4 rue Jean Giono','69000','LYON','2005-05-29','azerty',NULL,'GY'),('f4','Gest','Alain','30 rue Authie','46000','FIGEAC','2005-05-29','azerty',NULL,'GY'),('g19','Gheysen','Galassus','32 boulevard Mar Foch','75000','PARIS','2005-05-29','azerty',NULL,'SW'),('g30','Girard','Yvon','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','azerty','N','GY'),('g53','Gombert','Luc','32 rue Emile Gueymard','56000','VANNES','2012-05-25','azerty',NULL,'GY'),('g7','Guindon','Caroline','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25','azerty',NULL,'GY'),('h13','Guindon','Fran?ois','44 rue Picoti?re','19000','TULLE','2012-05-25','azerty',NULL,'SW'),('h30','Igigabel','Guy','33 rue Arlequin','94000','CRETEIL','2008-06-19','azerty',NULL,'SW'),('h35','Jourdren','Pierre','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19','azerty',NULL,'GY'),('h40','Juttard','Pierre-Raoul','34 cours Jean Jaur','8000','SEDAN','2008-06-19','azerty',NULL,'GY'),('j45','Eur?-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','azerty','N','SW'),('j50','Landr','Philippe','4 avenue du G?n?ral Laperrine','59000','LILLE','2000-05-01','azerty',NULL,'GY'),('j8','Langeard','Hugues','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','azerty','P','GY'),('k4','Lanne','Bernard','4 rue Bayeux','30000','NIMES','2000-05-01','azerty',NULL,'SW'),('k53','Le','No','4 avenue Beauvert','68000','MULHOUSE','2000-05-01','azerty',NULL,'SW'),('l14','Le','Jean','39 rue Raspail','53000','LAVAL','2000-05-01',NULL,'az','SW'),('l23','Leclercq','Servane','11 rue Quinconce','18000','BOURGES','1998-11-23','azerty',NULL,'SW'),('l46','Lecornu','Jean-Bernard','4 boulevard du Mar?chal Foch','72000','LA FERTE BERNARD','1998-11-23','azerty',NULL,'GY'),('l56','Lecornu','Ludovic','4 rue Abel Servien','25000','BESANCON','1998-11-23','azerty',NULL,'SW'),('m35','Lejard','Agn','4 rue Anthoard','82000','MONTAUBAN','1998-11-23','azerty',NULL,'SW'),('m45','Lesaulnier','Pascal','47 rue Thiers','57000','METZ','1998-11-23','azerty',NULL,'SW'),('n42','Letessier','St?phane','5 chemin de Capuche','27000','EVREUX','1998-11-23','azerty',NULL,'GY'),('n58','Loirat','Didier','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23','azerty',NULL,'GY'),('n59','Maffezzoli','Thibaud','5 rue Chateaubriand','2000','LAON','2005-12-21','azerty',NULL,'SW'),('o26','Mancini','Anne','5 rue D\'\'Agier','48000','MENDE','2005-12-21','azerty',NULL,'GY'),('p32','Marcouiller','G?rard','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21','azerty',NULL,'GY'),('p40','Michel','Jean-Claude','5 rue Gabriel P?ri','61000','FLERS','2005-12-21','azerty','O','SW'),('p41','Montecot','Fran?oise','6 rue Paul Val?ry','17000','SAINTES','2005-12-21','azerty',NULL,'GY'),('p42','Notini','Veronique','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21','azerty',NULL,'SW'),('p49','Onfroy','Den','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21','azerty',NULL,'GY'),('p6','Pascreau','Charles','57 boulevard Mar Foch','64000','PAU','1997-03-30','azerty',NULL,'SW'),('p7','Pernot','Claude-No','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02','azerty',NULL,'SW'),('p8','Perrier','Ma?tre','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23','azerty',NULL,'GY'),('q17','Petit','Jean-Louis','7 rue Ernest Renan','50000','SAINT LO','2009-06-07','azerty',NULL,'GY'),('r24','Piquery','Patrick','9 rue Vaucelles','14000','CAEN','2007-04-29','azerty','O','GY'),('r58','Quiquandon','Jo?ll','7 rue Ernest Renan','29000','QUIMPER','2006-09-30','azerty',NULL,'GY'),('s10','Retailleau','Josselin','88 bis rue Saumuroise','39000','DOLE','2011-12-05','azerty',NULL,'SW'),('s21','Retailleau','Pascal','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09','azerty',NULL,'SW'),('t43','Souron','Maryse','7B rue Gay Lussac','21000','DIJON','2003-09-03','azerty',NULL,'SW'),('t47','Tiphagne','Patrick','7B rue Gay Lussac','62000','ARRAS','1997-08-29','azerty',NULL,'SW'),('t55','Tr?het','Alain','7D chemin Barral','12000','RODEZ','1994-11-29','azerty',NULL,'SW'),('t60','Tusseau','Josselin','63 rue Bon Repos','28000','CHARTRES','1991-03-29','azerty',NULL,'GY');
...
-- Dump completed on 2018-05-06 23:26:27
